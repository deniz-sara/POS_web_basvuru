...
// Email şablonları
const QNB_LOGO = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/QNB_Finansbank_logo.svg/800px-QNB_Finansbank_logo.svg.png";
  ...
  basvuruAlindiMusteri: (data) => ({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:20px;border-radius:10px;border:1px solid #ddd">
        ${headerHtml('POS Başvurusu Alındı')}
        <div style="background:#fff;padding:30px;border-radius:0 0 8px 8px">
          <p style="color:#333;font-size:16px">Sayın <strong>${data.yetkili_ad_soyad}</strong>,</p>
          <p style="color:#555">QNBpay fiziki POS başvurunuz başarıyla alınmıştır. İlgili birimlerimiz en kısa sürede değerlendirmeyi tamamlayacaktır.</p>
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:20px;border-radius:10px;border:1px solid #ddd">
        ...
        <div style="padding:30px;background:#fff;border-radius:0 0 8px 8px">
          <table style="width:100%;border-collapse:collapse">
            ...
            <tr><td style="padding:10px;border-bottom:1px solid #eee;color:#666">POS Talebi</td><td style="padding:10px;border-bottom:1px solid #eee">${data.pos_adedi} adet ${data.pos_tipi}</td></tr>
